...
export const skills: SkillsData = {
  languages: [
    { name: "Python", icon_url: "https://s3.dualstack.us-east-2.amazonaws.com/pythondotorg-assets/media/files/python-logo-only.svg" },
    { name: "Java", icon_url: "https://upload.wikimedia.org/wikipedia/pt/3/30/Java_programming_language_logo.svg" },
  ...
  data: [
    ...
    { name: "Matplotlib", icon_url: "https://upload.wikimedia.org/wikipedia/commons/8/84/Matplotlib_icon.svg" },
  ],
  libraries: [
